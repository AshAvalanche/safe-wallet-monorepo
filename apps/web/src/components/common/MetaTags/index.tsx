...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://wallet.ash.center/images/social-share.png" />
    ...
    <meta name="twitter:image" content="https://wallet.ash.center/images/social-share.png" />
