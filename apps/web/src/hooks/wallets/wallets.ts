...
// Intentionally omit @web3-onboard/coinbase — its SDK probes local apps and triggers
// Chrome's "Access other apps…" permission. Coinbase extension still works via injected.
